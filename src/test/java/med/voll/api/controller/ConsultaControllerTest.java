...
class ConsultaControllerTest {
    ...
    @WithMockUser
    public void agendar_opcao1() throws Exception {
    ...
    @WithMockUser
    public void agendar_opcao2() throws Exception {
        ...
        var retornoJson = dadosDetalhamentoConsultaJson.write(
                dadosDetalhamento
        ).getJson();

        assertThat(response.getContentAsString()).isEqualTo(retornoJson);
    }
